<?php component('/components/common/header?title=' . $class_info['title'] . '-论坛中心-安米社区-专注于手机网站建设' ); ?>
<?php component('/components/common/header_nav', [
    'title' => $class_info['title']
]); ?>
<div class="bbas_action">
    <div class="create_time">发帖 <?=$list->total()?> 篇</div>
    <div class="create_time reply">有1258人评论</div>
