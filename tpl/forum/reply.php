<?php self::load('Common/header',['title' => '查看帖子回复']); ?>
<div class="header">
...
<div class="content-main">
    <div class="view_head border-b">
        <div class="view_title"><a href="/forum/view?id=<?=$forum_info['id']?>"><?=$forum_info['title']?></a></div>
...
<div class="reply_body">
    <div class="reply_input border-t">
        <form class="reply_index" action="/forum/reply_add?way=1&amp;id=<?=$forum_info['id']?>" method="post">
