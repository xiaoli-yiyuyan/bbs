<?php $this->load('components/common/user_header',['title' => '关注/粉丝列表']); ?>
...
<div class="tab ">
    ...
    <div class="tab-content">
            <div class="tab-page tab1 tab-active">
                <?php $this->load('components/user/friend_list', ['list' => $care_list]); ?>
            </div>
            <div class="tab-page tab2">
                <?php $this->load('components/user/friend_list', ['list' => $fans_list, 'is_fans_care' => 'fans']); ?>
            </div>
    </div>
</div>
