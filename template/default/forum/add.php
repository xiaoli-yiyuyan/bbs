<?php $this->load('/components/common/user_header', ['title' => $column_info['title'] . '-帖子发布']); ?>
<?php $this->load('/components/common/header_nav', ['back_url' => '/forum/list?id=' . $column_info['id'], 'title' => $column_info['title']]); ?>
