...
<form class="box-padding" action="/Novel/add" method="post">
    ...
    <div class="item-line item-lg">
        ...
        <div class="item-input">
            <input name="is_over" type="radio" value="0" id="is_over_0" checked><label for="is_over_0">连载中</label>
            <input name="is_over" type="radio" value="1" id="is_over_1"><label for="is_over_1">已完结</label>
        </div>
    </div>
