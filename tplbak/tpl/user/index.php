...
<div class="change-info">
    ...
    <div class="li-box border-b">
        <a href="/forum/my_list/" class="flex-box">
            <div><i class="li-box-svg icon-svg b_shoubing"></i></div>
            <div class="li-box-word">帖子(<?=$bbs['count']?>)</div>
            <div class="ellipsis more bbs_article" data-id="<?=$bbs['id']?>"><?=$bbs['title']?></div>
        </a>
    </div>
    ...
    <div class="li-box border-b">
        <a href="/forum/my_list/" class="flex-box">
            <div><i class="li-box-svg icon-svg b_shoubing"></i></div>
            <div class="li-box-word">
                <div>回复(<?=$reply['count']?>)</div>
            </div>
            <div class="ellipsis more bbs_reply" data-forum-id="<?=$reply['forum_id']?>"><?=$reply['context']?></div>
        </a>
    </div>
